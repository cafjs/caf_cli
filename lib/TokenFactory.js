 ...
 *
 * Extended properties in `Session.options` object:
 *
 *     {password:string, accountsURL:string, unrestrictedToken:boolean,
 *      appPublisher:string, appLocalName:string, durationInSec: number}
 *
 * where:
 *
 *    * `accountsURL`: The url for a authentication service.
 *    * `unrestrictedToken`: True if the token authenticates to all apps.
 *    * `appPublisher`:  Publisher of the app hosting CAs.
 *    * `appLocalName`: Name of the app in the `appPublisher` context.
 *    * `durationInSec`: Time in seconds from `now` till token expires.
 *
 ...
 * Constructor.
 *
 * @param {caf.sessionOptions} options Extended properties.
 *
...
exports.TokenFactory = function(options) {
     ...
     * @param {caf.cb} cb A callback to return the new token or an error.
     *
     * @memberof! module:caf_cli/TokenFactory#
     * @alias newToken
     */
