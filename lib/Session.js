...
var srpUtils = require('caf_security').srp.utils;

var tf = require('./TokenFactory');

exports.TokenFactory = tf.TokenFactory;
...
var Session = exports.Session = function(url, caId, options) {
    ...
    options.newToken = options.newToken || function(msg, cb) {
        // lazy initialization
        tokenFactory = tokenFactory || (new tf.TokenFactory(options));
        tokenFactory.newToken(msg, cb);
    };
    ...
    try {
        var h = srpUtils.splitName(parsedURL.hostname.split('.')[0]);
