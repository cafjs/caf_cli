...
exports.newInstance = function() {
    ...
    var dh = crypto.createDiffieHellman(Buffer.from(DH_PRIME, 'hex'),
    ...
    var setMasterKey = function(masterKey) {
        ...
        var tempKey = hash.update(masterKey).digest();
    ...
    that.setOtherPublicKey = function(otherPubKey) {
        var other = Buffer.from(otherPubKey, 'hex');
